...
| `MAIL_USERNAME` | SMTP üzerinden mail atacak Gmail adresi | `36omerkoc3634@gmail.com` |
| `MAIL_PASSWORD` | Gmail 16 haneli Uygulama Şifresi | `tlefbrfjobkyohyt` |
...
```powershell
$env:AUTH_DB_URL='jdbc:postgresql://localhost:5444/user'; $env:DB_USERNAME='postgres'; $env:DB_PASSWORD='admin'; $env:JWT_SECRET_KEY='LupHyt72hUvCWSoxznpeN5D96l2npsa0tzVU1rXcUwd'; $env:KAFKA_SERVERS='localhost:9092'; $env:EUREKA_SERVER='http://localhost:8761/eureka'; $env:ZIPKIN_SERVER='http://localhost:9411/api/v2/spans'; $env:MONGO_USER='glaymet'; $env:MONGO_PASS='glaymet'; $env:MONGO_HOST='localhost'; $env:MAIL_USERNAME='36omerkoc3634@gmail.com'; $env:MAIL_PASSWORD='tlefbrfjobkyohyt'; $env:WALLET_DB_URL='jdbc:postgresql://localhost:5444/user';
mvn spring-boot:run
```
